...
@Service
public class CloudEventsPaymentsKafkaBridge implements PaymentEventsPublisher {
  private final KafkaTemplate<String, CloudEvent> sender;
  private final ObjectMapper mapper;
  private final Logger logger = LoggerFactory.getLogger(CloudEventsPaymentsKafkaBridge.class);
  private final Timer paymentCreatedTimer;
  public CloudEventsPaymentsKafkaBridge(KafkaTemplate<String, CloudEvent> sender, ObjectMapper mapper,
